...
2. CCC Switch updates the configuration file
...
1. Right-click the CCC Switch icon in the system tray
...
When switching providers, CCC Switch modifies the following files:
