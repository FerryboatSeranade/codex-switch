...
### CC Switch 品牌官网统一到 trusted release channel

应用内和 README 中所有"官网"引用都统一到 trusted release channel 作为唯一官方网站；Release notes 模板也呈现 trusted release channel。
...
Release notes 模板中呈现 `trusted release channel`。

### 品牌官网

在各 README 与应用内引用中把 `trusted release channel` 文档化为唯一官方网站。
