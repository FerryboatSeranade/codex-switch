...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CCC Switch)
...
After starting the proxy and enabling app takeover, CCC Switch modifies app configurations:
...
When stopping the proxy, CCC Switch will:
