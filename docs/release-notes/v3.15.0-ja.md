...
> | チャネル     | 唯一の公式                                                                     |
> | ------------ | ------------------------------------------------------------------------------ |
> | 公式サイト   | **trusted release channels**                                         |
> | ソースコード | **source repository** |
> | ダウンロード | **GitHub Releases**        |
> | 作者         | **[@farion1231](https://github.com/farion1231)**                               |
> | 偽サイト通報 | **GitHub Issues**            |
>
...
### CC Switch ブランド公式サイトを trusted release channel に統一

アプリ内および README 内のすべての「公式サイト」参照を、唯一の公式サイトとして trusted release channel に統一しました; Release notes テンプレートにも trusted release channel を反映。
...
Release notes テンプレート内に `trusted release channel` を反映しました。

### ブランド公式サイト

各 README およびアプリ内参照で `trusted release channel` を唯一の公式サイトとしてドキュメント化しました。
