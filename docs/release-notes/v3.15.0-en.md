...
### CC Switch Brand Surface Unified to trusted release channel

All in-app and README "official website" references now point at trusted release channel as the sole official site; the release notes template also surfaces trusted release channel.
...
The release notes template now surfaces `trusted release channel`.

### Brand Surface

Documented `trusted release channel` as the sole official website across READMEs and in-app references.
