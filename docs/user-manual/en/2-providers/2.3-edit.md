...
CCC Switch provides rich icon customization features:
...
This ensures CCC Switch and CLI tool configurations stay in sync.
...
When adding a provider, CCC Switch automatically extracts endpoint URLs from the configuration.
