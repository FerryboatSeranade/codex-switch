...
//!
//! Parses cccswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a cccswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// cccswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "cccswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'cccswitch', got '{scheme}'"
        )));
    }
