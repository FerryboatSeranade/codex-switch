...
> 💡 Special thanks to [@EldenPdx](https://github.com/EldenPdx) for PR #2804: this feature's Chat ↔ Responses format conversion references the implementation in his PR.
